...
class assign {
    ...
    protected function get_notifiable_users($userid) {
        return $this->get_filtered_graders($userid, 'mod/assign:receivegradernotifications', true);
    }
    ...
    protected function get_filtered_graders(int $userid, string $capability, bool $checkallocation = true): array {
        ...
        $coursegraders = get_enrolled_users($this->context, $capability, null, 'u.*');
