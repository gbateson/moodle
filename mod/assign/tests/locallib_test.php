...
final class locallib_test extends \advanced_testcase {
    ...
    /**
     * Test that get_notifiable_users only returns the allocated marker when marking allocation is active,
    ...
    public function test_get_notifiable_users_with_marking_allocation(): void {
        ...
        $userflags = $assign->get_user_flags($student->id, true);

        // Directly set the allocated marker on the existing complete record object.
        $userflags->allocatedmarker = $marker1->id;

        // Pass the fully populated object back to core to save.
